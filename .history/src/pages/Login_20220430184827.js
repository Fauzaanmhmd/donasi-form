...
const Login = () => {
  ...
  const handleOnChangeDonasi = (e) => setDonasi(e.target.value)
              ...
              {({ input, meta }) => (
                <Content>
                  <Grid item xs={12} style={{
                    ...
                    <Donasi handleOnChange={handleOnChangeDonasi} {...input} type="number" placeholder="Masukkan Donasi Kamu Kamu" label="Donasi" variant="outlined" onKeyPress={handleFocus} fullWidth />
                    {meta.error && meta.touched && <ErrorMessage>{meta.error}</ErrorMessage>}
                  </Grid>
                </Content>
              )}
