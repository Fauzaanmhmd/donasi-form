                            ...
                            {({ input, meta }) => (
                                <Box className={classes.content}>
                                    <Grid item xs={12} className={classes.contentForm}>
                                        ...
                                        />
                                        {(meta.error && meta.touched) && (<Typography className={classes.errorMessage}>{meta.error || { isErrorEmail && email}}</Typography>)}
                                        {isErrorEmail && email && <Typography className={classes.errorMessage}>tidak valid</Typography>}
                                    </Grid>
                                </Box>
                            )}
                        </Field>
                            ...
                            {({ input, meta }) => (
                                <Box className={classes.content}>
                                    <Grid className={classes.donasiContainer} item xs={12}>
                                        {console.log(donasi)}
                                        {console.log(focusDonasi, "iniDonasi")}
                                        {
                                            (focusDonasi && donasi) && (
