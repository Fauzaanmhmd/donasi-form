...
import { Box, styled, Button, Grid, TextField, FormControl } from '@mui/material';
              ...
              {({ input, meta }) => (
                <Content>
                  <Grid item xs={12} style={{
                    ...
                    <TextField {...input} value={email} onChange={emailValidation} type="email" placeholder="Enter email" label="Email" variant="outlined" fullWidth sx={{
                      margin: "10px"
                    }} />
              ...
              {({ input, meta }) => (
                <Content>
                  <Grid item xs={12} style={{
                    ...
                    <TextField {...input} type="password" placeholder="Masukkan Password Kamu" label="Password" onKeyPress={handleFocus} variant="outlined" fullWidth />
                    {meta.error && meta.touched && <ErrorMessage>{meta.error}</ErrorMessage>}
              ...
              {({ input, meta }) => (
                <Content>
                  <Grid item xs={12} style={{
                    ...
                    <Donasi {...input} type="number" placeholder="Masukkan Donasi Kamu Kamu" label="Donasi" variant="outlined" onKeyPress={handleFocus} fullWidth sx={{
                      margin: "10px"
                    }} />
                    {meta.error && meta.touched && <ErrorMessage>{meta.error}</ErrorMessage>}
                  </Grid>
