...
const requiredEmail = value => (value ? undefined : 'Email Tidak Boleh')
const requiredPassword = value => (value ? undefined : 'Password Tidak Boleh')
const requiredDonation = value => (value ? undefined : 'Donasi Tidak Boleh')
