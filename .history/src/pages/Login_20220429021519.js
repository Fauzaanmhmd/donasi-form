              ...
              {({ input, meta }) => (
                <div style={{
                  ...
                  <Grid item xs={12} style={{
                    ...
                    <TextField value={email} className={`${emailOutline === "outline"}`} {...input} type="email" placeholder="Enter email" label="Email" variant="outlined" fullWidth onKeyPress={handleFocus} onChange={handleOnChange} style={{
                      margin: "10px"
                    }} />
