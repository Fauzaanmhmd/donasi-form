          ...
          <form onSubmit={handleSubmit}>
              ...
              {({ input, meta }) => (
                <Box className={classes.content}>
                  <Grid item xs={12} className={classes.contentForm}>
                    ...
                    <TextField {...input} onChange={handleOnChange} value={email} error={meta.error && meta.touched} type="email" placeholder="Enter email" label="Email" variant="outlined" fullWidth className={classes.textField} />
            ...
            <Field name="lastName" validate={requiredPassword}>
              {({ input, meta }) => (
                <Box className={classes.content}>
                  <Grid item xs={12} className={classes.contentForm}>
                    <TextField {...input} type="password" placeholder="Masukkan Password Kamu" label="Password" onKeyPress={handleFocus} variant="outlined" fullWidth className={classes.textField} />
                    {meta.error && meta.touched && <Typography className={classes.errorMessage}>{meta.error}</Typography>}
